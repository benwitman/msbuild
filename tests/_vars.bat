...
if NOT "%MSBUILD_DOTNET_REPO%" == "" if NOT "%MSBUILD_DOTNET_VER%" == "" (
	set TEST_CUSTOM_DOTNET=%MSBUILD_DOTNET_REPO%\artifacts\bin\redist\debug\dotnet
	set TEST_CUSTOM_DOTNET_VERSION=%MSBUILD_DOTNET_VER%
)

if DEFINED TEST_CUSTOM_DOTNET (
	echo Using Private .NET SDK
