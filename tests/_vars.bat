...
set _Static_Artifacts_MsBuild=%~dp0..\artifacts\bin\MSBuild\x64\Debug\net472
set _Static_Artifacts_MicrosftBuildTasks=%~dp0..\artifacts\bin\Microsoft.Build.Tasks\x64\Debug\net472
